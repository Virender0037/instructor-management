<section>
    ...
    <form method="POST" action="{{ request()->is('superadmin*') ? route('superadmin.logout') : route('instructor.logout') }}" class="space-y-6 mt-6">
        @csrf
        @method('patch')
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="bg-btn-logoblue">{{ __('Opslaan') }}</x-primary-button>
